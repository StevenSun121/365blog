...
img1.onload = function () {
    if (isIe) {
        ...
        }, '/tools/img/alipay_logo.png'); ///tools/img/alipay_logo.png
    } else {
        ...
        var alipayDivsImg = new DivsImg({
            ...
            color: '#123',
            logoImgSrc: '/tools/img/alipay_logo.png', ///tools/img/alipay_logo.png
            logoLength: 5,
            cd: 1
        });
...
img1.src = '/tools/img/alipayQRCode.png'; ///tools/img/alipayQRCode.png
...
img2.onload = function () {
    if (isIe) {
        appendImgWithLogo(img2, {
            ...
            height: parseInt(winH / 3) + 'px',
            width: parseInt(winH / 3) + 'px'
        }, '/tools/img/tenpay_logo.png'); ///tools/img/tenpay_logo.png
    } else {
        ...
        var tenpayDivsImg = new DivsImg({
            ...
            color: '#123',
            logoImgSrc: '/tools/img/tenpay_logo.png', ///tools/img/tenpay_logo.png
            logoLength: 5,
            cd: 1
        });
...
img2.src = '/tools/img/tenpayQRCode.png'; ///tools/img/tenpayQRCode.png
